...
public class FragmentDangnhanAdapter extends RecyclerView.Adapter<FragmentDangnhanAdapter.ViewHolder>{

    private ArrayList<ModelSuco> list;

    public  FragmentDangnhanAdapter(ArrayList<ModelSuco> list, Context context){
        this.list = list;
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new FragmentDangnhanAdapter.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.item_dangnhan, parent, false));
    }
