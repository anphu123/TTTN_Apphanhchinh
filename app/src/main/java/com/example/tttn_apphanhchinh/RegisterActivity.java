...
import com.example.tttn_apphanhchinh.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void updateUserInfo() {
        ...
        hashMap.put("userType", "Quản trị viên"); // possible values are user, admin: will make admin manually realtime database by changing this value
